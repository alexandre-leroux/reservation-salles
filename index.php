 ...
 ?>
        ...
        <header class="masthead bg-primary text-white text-center d-flex align-items-center vh-100">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="medias/meeting-room.svg" alt="salle" /> 
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Les salles de l'avenir</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Reserver des espaces de travail d'un nouveau concept !</p>
            </div>
        </header>
